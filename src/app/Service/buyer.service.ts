...
export class BuyerService {
  private heroesUrl = 'http://localhost:3847/api/PRBuyerAPI/GetBuyers';  // URL to web api
  ...
  constructor(
   ...
   getHeroes (): Observable<OPEC_PRTYPE_BUYER[]> {
    return this.http.get<OPEC_PRTYPE_BUYER[]>(this.heroesUrl)
      .pipe(
  ...
  // addHero (hero: OPEC_PRTYPE_BUYER): Observable<OPEC_PRTYPE_BUYER> {
  //   return this.http.post<OPEC_PRTYPE_BUYER>(this.heroesUrl, hero, httpOptions).pipe(
