...
export class SaleFileSerService {
  ...
  addHero (hero: SaleFiles): Observable<SaleFiles> {
    return this.http.post<SaleFiles>(this.heroesUrl1, hero, httpOptions);
    // .pipe(
  ...
  deleteHero (hero: SaleFiles | number): Observable<{}> {
    // const id = typeof hero === 'number' ? hero : hero.id;
    const url = `${this.heroesUrl4}`;// /${id}

    return this.http.delete<SaleFiles>(url, httpOptions);
    // .pipe(
  ...
  updateHero (hero: SaleFiles): Observable<SaleFiles> {
    return this.http.put<SaleFiles>(this.heroesUrl3, hero, httpOptions);
    // .pipe(
