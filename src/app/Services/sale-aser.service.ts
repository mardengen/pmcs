...
export class SaleASerService {
  
  private heroesUrl1 = 'http://localhost:51962/api/Customer/AddCustomer?SiteNo=xx';  // URL to web api
  // private heroesUrl2 = 'http://localhost:51962/api/Customer/GetCustomers?SiteNo=xx';
  private heroesUrl3 = 'http://localhost:51962/api/Customer/PUTCustomer?SiteNo=xx';
  private heroesUrl4 = 'http://localhost:51962/api/Customer/DelCustomer?SiteNo=xx';
  ...
  // getHero(id: number): Observable<SaleAModel> {
  //   const url = `${this.heroesUrl2}/${id}`;
  //   return this.http.get<SaleAModel>(url);
  //   // .pipe(
  ...
  addHero (hero: SaleA): Observable<SaleA> {
    return this.http.post<SaleA>(this.heroesUrl3, hero, httpOptions);
    // .pipe(
  ...
  deleteHero (hero: SaleA | number): Observable<SaleA> {
    // const id = typeof hero === 'number' ? hero : hero.id;SaleA
    const url = `${this.heroesUrl4}`; // /${id} 

    return this.http.delete<SaleA>(url, httpOptions);
    //.pipe(
